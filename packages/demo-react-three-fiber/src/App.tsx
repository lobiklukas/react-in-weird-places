    ...
    <div style={{ width: '100vw', height: '100vh', backgroundColor: '#1a1a1a' }}>
      <div style={{
        ...
        <p style={{ margin: '0 0 8px 0', fontSize: '14px', lineHeight: '1.5' }}>
          This 3D scene is built with React components! R3F uses a custom reconciler 
          to map JSX to Three.js objects.
        </p>
        <ul style={{ margin: '8px 0', paddingLeft: '20px', fontSize: '13px' }}>
          <li><code>&lt;Box&gt;</code> → THREE.BoxGeometry</li>
          <li><code>&lt;Sphere&gt;</code> → THREE.SphereGeometry</li>
          <li><code>&lt;meshStandardMaterial&gt;</code> → THREE.MeshStandardMaterial</li>
        </ul>
