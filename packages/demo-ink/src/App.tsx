			...
			>
				{options[selectedOption].value === 'about' && (
					<Box flexDirection="column">
						...
						<Newline />
						<Text>
							Ink is a React custom reconciler for building CLI applications.
						</Text>
						<Text>
							Instead of rendering to the DOM, it renders to the terminal using
						</Text>
						...
						<Text dimColor>
							🎨 Styles: Flexbox layouts, colors, borders
						</Text>
					</Box>
				)}
				...
				{options[selectedOption].value === 'technical' && (
					<Box flexDirection="column">
						...
						<Text>
							• Ink implements react-reconciler to target the terminal
						</Text>
						<Text>
							• React elements map to terminal primitives (text, boxes)
						</Text>
						<Text>
							• Uses Yoga for flexbox layout calculations
						</Text>
						<Text>
