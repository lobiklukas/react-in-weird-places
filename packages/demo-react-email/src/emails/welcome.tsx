...
export const WelcomeEmail = ({ username = 'Developer' }: WelcomeEmailProps) => (
      ...
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={paragraph}>
            This email was created using React components! React Email uses React 
            as a templating engine to transform JSX into HTML email code that works 
  ...
  Click Me
          ...
          <Text style={footer}>
            This demo email is part of the "React in Weird Places" presentation.
            It showcases how React can be used as a templating engine for HTML emails, 
            without needing a custom reconciler.
          </Text>
        </Section>
      </Container>
    </Body>
