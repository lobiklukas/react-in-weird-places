      ...
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={paragraph}>
            React Email doesn't use a custom React reconciler at all. It simply uses React 
            as a templating engine via ReactDOMServer to generate static HTML optimized for 
            email clients. No reconciler needed because there are no updates or live UI trees.
          </Text>
          ...
          <Text style={paragraph}>
            Email clients are notoriously inconsistent. Modern CSS and JavaScript don't work.
            We need to compile to a specific subset of HTML that all clients support.
          </Text>
          
          <Section style={codeBox}>
            <Code style={code}>
{`// ❌ This won't work in emails
      ...
      <a href="...">Click me</a>
          ...
          <Section style={highlightBox}>
            <Text style={highlightText}>
              💡 <strong>Key Insight:</strong> React Email doesn't need a custom reconciler
              because it's not managing updates or a live UI tree. It's using React as a
              templating engine to generate static, email-compatible HTML.
            </Text>
          </Section>
          ...
          <Text style={paragraph}>
            You need a custom reconciler when:
          </Text>
          ...
          <Text style={paragraph}>
            Examples: React Native, React Three Fiber, Ink, React PDF
          </Text>
          
          <Hr style={hr} />
          
          <Text style={footer}>
            Part of the "React in Weird Places" demo collection
          </Text>
        </Section>
      </Container>
    </Body>
