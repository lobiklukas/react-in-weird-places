...
interface VehicleApi {
  ...
  setBrake: (force: number, wheelIndex: number) => void
...
interface ChassisApi {
  ...
  applyLocalImpulse: (force: [number, number, number], offset: [number, number, number]) => void
}
...
const useControls = (vehicleApi: VehicleApi | undefined, chassisApi: ChassisApi | undefined) => {
