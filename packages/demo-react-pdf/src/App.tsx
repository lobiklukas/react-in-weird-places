  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          1. React components describe the document structure
        </Text>
        <Text style={styles.text}>
          2. Custom reconciler translates to PDF operations
        </Text>
        <Text style={styles.text}>
          3. Output: Native PDF without HTML/CSS conversion
        </Text>
      </View>
  ...
  <Page>
    <Text>Hello PDF!</Text>
      ...
      <Text style={styles.footer}>
        Generated with @react-pdf/renderer | Page 1
      </Text>
    </Page>
  ...
  title: {
    ...
    fontWeight: 'bold',
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Maps React elements to PDF primitives (PDFKit)
        </Text>
        <Text style={styles.text}>
          • Handles layout calculations via Yoga
        </Text>
        <Text style={styles.text}>
          • Manages the commit phase to render final PDF
        </Text>
      </View>

      <Text style={styles.footer}>
        Generated with @react-pdf/renderer | Page 2
      </Text>
    </Page>
  </Document>
);
